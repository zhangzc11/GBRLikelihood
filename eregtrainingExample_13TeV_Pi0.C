...
void eregtrainingExample_13TeV_Pi0(bool dobarrel=true, bool doele=false) {
  doele=false;
//  dobarrel=true;
 
  //output dir
  //TString dirname = "/data/bendavid/eregexampletest/"; 
  TString dirname = "eregexampletest/"; 
...
///////////////////////////////////////////////////////////////
	...
	varsf->push_back("STr2_Es_e1_1/STr2_Es_e2_1");
    	varsf->push_back("STr2_enG1_rec/cosh(STr2_Eta_1)");
...
//  varsee->push_back("ph.scpse/ph.scrawe");
  ...
  RooRealVar *tgtvar = new RooRealVar("tgtvar","STr2_enG1_true/STr2_enG1_nocor",1.);//("tgtvar","ph.gene/ph.scrawe",1.);
