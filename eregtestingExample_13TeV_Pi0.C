...
void eregtestingExample_13TeV_Pi0(bool dobarrel=true, bool doele=false) {
  
  //output dir
  
  TString dirname = "eregexampletest_test/EE";//"/data/bendavid/eregexampletest/eregexampletest_test/"; 
  if(dobarrel)
	{
	dirname = "eregexampletest_test/EB";
	}
  ...
  TString infile = TString::Format("../../eregexampletest/%s",fname.Data());
