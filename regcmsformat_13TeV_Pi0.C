...
void regcmsformat_13TeV_Pi0(bool dobarrel=true, bool doele=false) {
  
  //output dir
   TString dirname = "ereg_cms/EB";
   if(!dobarrel)
	dirname = "ereg_cms/EE"; 
  ...
  TString fname;
  if (doele && dobarrel) 
    fname = "../../ereg_ws_Full/bothGammas/wereg_ele_eb.root";
  else if (doele && !dobarrel) 
    fname = "../../ereg_ws_Full/bothGammas/wereg_ele_ee.root";
  else if (!doele && dobarrel) 
    fname = "../../ereg_ws_Full/bothGammas/wereg_ph_eb.root";
  else if (!doele && !dobarrel) 
    fname = "../../ereg_ws_Full/bothGammas/wereg_ph_ee.root";
...
//  ROOT::Cintex::Cintex::Enable();
  ...
  fout->WriteObject(forestout,"Correction");
  fout->Close();
