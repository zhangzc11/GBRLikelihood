...
void eregtesting_13TeV_Pi0(bool dobarrel=true, bool doele=false, bool gamma2 = false) {
  ...
  TString dirname = TString::Format("ereg_test_plots/%s_%s",gamma1or2.Data(),EEorEB.Data());// = "ereg_test_gamma1/EE";//"/data/bendavid/eregexampletest/eregexampletest_test/"; 
  ...
  TString infile = TString::Format("../../ereg_ws/%s/%s",gamma1or2.Data(),fname.Data());
