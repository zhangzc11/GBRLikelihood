...
void eregtraining_13TeV_Pi0_oldDist(bool dobarrel=true, bool doele=false, int gammaID=0) {
...
//    tree->Add("/data/bendavid/regTreesAug1/hgg-2013Final8TeV_reg_s12-pj40-2em-v7n_noskim.root");    
    ...
    if(dobarrel)
    {
    tree->Add("/afs/cern.ch/work/z/zhicaiz/public/ECALpro_MC_TreeForRegression/ND/PU_Spring16_EB_combine_train.root");      
    }
    else
     {
  ...
  TCut selcut = "(STr2_enG_nocor/cosh(STr2_Eta)>1.0) && (STr2_S4S9 > 0.75) && (STr2_isMerging < 2) && (STr2_DeltaR < 0.03) && (STr2_ptPi0_nocor>3.0) && (STr2_DeltaRG1G2<0.1) && (STr2_enG_nocor>1.0)";
  //TCut selcut = "(STr2_enG_nocor/cosh(STr2_Eta)>1.0) && (STr2_S4S9 > 0.75) && (STr2_isMerging < 2) && (STr2_DeltaR < 0.03) && (STr2_mPi0_nocor>0.1)";
...
/*
  RooRealVar sigalphavar("sigalphavar","",2.);
...
//  RooGBRFunctionFlex *sigalphafunc = new RooGBRFunctionFlex("sigalphafunc","");
//  RooGBRFunctionFlex *sigalpha2func = new RooGBRFunctionFlex("sigalpha2func","");
...
//  RooGBRTargetFlex *sigalphat = new RooGBRTargetFlex("sigalphat","",*sigalphafunc,sigalphavar,condvars);  
//  RooGBRTargetFlex *sigalpha2t = new RooGBRTargetFlex("sigalpha2t","",*sigalpha2func,sigalpha2var,condvars);  
...
//  RooRealConstraint sigalphalim("sigalphalim","",*sigalphat,0.01,10.); 
//  RooRealConstraint sigalpha2lim("sigalpha2lim","",*sigalpha2t,0.01,10.); 
