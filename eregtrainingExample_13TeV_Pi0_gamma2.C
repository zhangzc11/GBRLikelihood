...
void eregtrainingExample_13TeV_Pi0_gamma2(bool dobarrel=true, bool doele=false) {
  doele=false;
//  dobarrel=true;
 
  //output dir
  //TString dirname = "/data/bendavid/eregexampletest/"; 
  TString dirname = "eregexampletest_gamma2/"; 
...
///////////////////////////////////////////////////////////////
	...
	varsf->push_back("STr2_Es_e1_2/STr2_Es_e2_2");
    	varsf->push_back("STr2_enG2_rec/cosh(STr2_Eta_2)");
...
//  varsee->push_back("ph.scpse/ph.scrawe");
  ...
  RooRealVar *tgtvar = new RooRealVar("tgtvar","STr2_enG2_true/STr2_enG2_nocor",1.);//("tgtvar","ph.gene/ph.scrawe",1.);
