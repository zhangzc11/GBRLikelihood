...
if __name__ == "__main__":
	...
	env_script_f.write("#!/bin/bash\n")
 	env_script_f.write("cd " + work_directory + "\n")
       	...
       	env_script_f.write("root -q -l -b eregtraining_13TeV_Pi0_singleGamma.C+\\("+dobarrel+",false,"+gamma2+"\\) \n")
       	env_script_f.write("root -q -l -b eregtesting_13TeV_Pi0_singleGamma.C+\\("+dobarrel+",false,"+gamma2+"\\) \n")
       	env_script_f.write("date \n")
