...
root -q -l -b eregtraining_13TeV_Pi0.C+(false,false,1) > log/reg_log_EE_both.log
root -q -l -b eregtraining_13TeV_Pi0.C+(true,false,1) > log/reg_log_EBi_both.log 
...
root -q -l -b eregtraining_13TeV_Pi0.C+(false,false,2) > log/reg_log_EE_both.log
root -q -l -b eregtraining_13TeV_Pi0.C+(true,false,2) > log/reg_log_EBi_both.log 
