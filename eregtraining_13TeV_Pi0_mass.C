...
void eregtraining_13TeV_Pi0_mass(bool dobarrel=true) {
...
std::vector<std::string> *varsf_ph1 = new std::vector<std::string>;
std::vector<std::string> *varseb_ph1;
std::vector<std::string> *varsee_ph1;

varsf_ph1->push_back("STr2_enG1_nocor");
varsf_ph1->push_back("STr2_Eta_1");
varsf_ph1->push_back("STr2_Phi_1");

varsf_ph1->push_back("STr2_Nxtal_1");//number of crystals receive a certain portion(?) of energy

varsf_ph1->push_back("STr2_S4S9_1");
varsf_ph1->push_back("STr2_S1S9_1");
varsf_ph1->push_back("STr2_S2S9_1");
varsf_ph1->push_back("STr2_DeltaRG1G2");

varsf_ph1->push_back("STr2_iEtaiX_1");
varsf_ph1->push_back("STr2_iPhiiY_1");


varseb_ph1 = new std::vector<std::string>(*varsf_ph1);
varsee_ph1 = new std::vector<std::string>(*varsf_ph1);  

varsee_ph1->push_back("STr2_Es_e1_1");//the gamma energy in the first layer of the preshower
varsee_ph1->push_back("STr2_Es_e2_1");
varseb_ph1->push_back("STr2_iEta_1on5");
varseb_ph1->push_back("STr2_iPhi_1on2");
varseb_ph1->push_back("STr2_iPhi_1on20");
varseb_ph1->push_back("STr2_iEta_1on2520");

std::vector<std::string> *varslist_ph1;
if (dobarrel) varslist_ph1 = varseb_ph1;
else varslist_ph1 = varsee_ph1;

std::vector<std::string> *varsf_ph2 = new std::vector<std::string>;
std::vector<std::string> *varseb_ph2;
std::vector<std::string> *varsee_ph2;

varsf_ph2->push_back("STr2_enG2_nocor");
varsf_ph2->push_back("STr2_Eta_2");
varsf_ph2->push_back("STr2_Phi_2");

varsf_ph2->push_back("STr2_Nxtal_2");//number of crystals receive a certain portion(?) of energy

varsf_ph2->push_back("STr2_S4S9_2");
varsf_ph2->push_back("STr2_S1S9_2");
varsf_ph2->push_back("STr2_S2S9_2");
varsf_ph2->push_back("STr2_DeltaRG1G2");

varsf_ph2->push_back("STr2_iEtaiX_2");
varsf_ph2->push_back("STr2_iPhiiY_2");


varseb_ph2 = new std::vector<std::string>(*varsf_ph2);
varsee_ph2 = new std::vector<std::string>(*varsf_ph2);  

varsee_ph2->push_back("STr2_Es_e1_2");//the gamma energy in the first layer of the preshower
varsee_ph2->push_back("STr2_Es_e2_2");
varseb_ph2->push_back("STr2_iEta_2on5");
varseb_ph2->push_back("STr2_iPhi_2on2");
varseb_ph2->push_back("STr2_iPhi_2on20");
varseb_ph2->push_back("STr2_iEta_2on2520");

std::vector<std::string> *varslist_ph2;
if (dobarrel) varslist_ph2 = varseb_ph2;
else varslist_ph2 = varsee_ph2;


  RooArgList vars_ph1;
  RooArgList vars_ph2;
  RooArgList vars_all;
  for (unsigned int ivar=0; ivar<varslist_ph1->size(); ++ivar) 
    {
    if(varslist_ph1->at(ivar).c_str()!=varslist_ph2->at(ivar).c_str())
    {
    RooRealVar *var_ph1 = new RooRealVar(TString::Format("var_ph1_%i",ivar),varslist_ph1->at(ivar).c_str(),0.);
    RooRealVar *var_ph2 = new RooRealVar(TString::Format("var_ph2_%i",ivar),varslist_ph2->at(ivar).c_str(),0.);
    vars_ph1.addOwned(*var_ph1);
    vars_ph2.addOwned(*var_ph2);
    vars_all.addOwned(*var_ph1);
    vars_all.addOwned(*var_ph2);
    }
    else       	
	{
    RooRealVar *var = new RooRealVar(TString::Format("var_commom_%i",ivar),varslist_ph1->at(ivar).c_str(),0.);
    vars_ph1.addOwned(*var);
    vars_ph2.addOwned(*var);
    vars_all.addOwned(*var);
	}
    }
...
/*  RooRealVar *tgtvar = new RooRealVar("tgtvar","sqrt(2.0*ph1.scrawe*ph2.scrawe*(1.0-costheta)",1.);
  ...
  RooRealVar *tgtvar = new RooRealVar("tgtvar","STr2_mPi0_nocor",1.);

  const double pdgPi0mass = 0.1349766;//91.1876;
  const double logpdgPi0mass = log(pdgPi0mass);
  
  //RooRealVar *mass = new RooRealVar("mass","mass",90.,70.,110.);
  RooRealVar *mass = new RooRealVar("STr2_mPi0_nocor","STr2_mPi0_nocor",0.13,0.02,0.26);
  
  //RooRealVar *logmass = new RooRealVar("logmass",TString::Format("log(STr2_mPi0_nocor)-log(0.1349766)",logpdgPi0mass),0,log(0.02)-logpdgPi0mass,log(0.26)-logpdgPi0mass);
  RooRealVar *logmass = new RooRealVar("logmass","log(STr2_mPi0_nocor)-log(0.1349766)",0.0,log(0.02)-logpdgPi0mass,log(0.26)-logpdgPi0mass);
//   RooRealVar *relpt_ph1 = new RooRealVar("relpt_ph1","ph1.pt/mass",1.);
//   RooRealVar *relpt_ph2 = new RooRealVar("relpt_ph2","ph2.pt/mass",1.);
  RooRealVar *relpt_ph1 = new RooRealVar("relpt_ph1","STr2_enG1_nocor/cosh(STr2_Eta_1)",1.);
  RooRealVar *relpt_ph2 = new RooRealVar("relpt_ph2","STr2_enG2_nocor/cosh(STr2_Eta_2)",1.);  
  RooRealVar *eta_ph1 = new RooRealVar("eta_ph1","STr2_Eta_1",1.);
  RooRealVar *eta_ph2 = new RooRealVar("eta_ph2","STr2_Eta_2",1.);
  RooRealVar *cosdphi = new RooRealVar("cosdphi","TMath::Cos(STr2_Phi_1-STr2_Phi_2)",1.);
  
  //RooRealVar *evt = new RooRealVar("evt","evt",0.);
  RooRealVar *evt = new RooRealVar("evt","Entry$",0.);
  ...
  RooRealVar *gene_ph1 = new RooRealVar("gene_ph1","STr2_enG1_true",0.);
  RooRealVar *gene_ph2 = new RooRealVar("gene_ph2","STr2_enG2_true",0.);
...
*/
   ...
   TChain *treedata = new TChain("Tree_Optim");
    if(dobarrel)
    {
    treedata->Add("/afs/cern.ch/work/z/zhicaiz/public/ECALpro_MC_TreeForRegression/sum_Pi0Gun_Flat0to50bx25_EB.root");
    }
    else
     {
    treedata->Add("/afs/cern.ch/work/z/zhicaiz/public/ECALpro_MC_TreeForRegression/sum_Pi0Gun_Flat0to50bx25_EE.root");
     }
...
//   return;
  ...
  TCut selcut = "STr2_mPi0_nocor >0.02 && STr2_mPi0_nocor < 0.26 && STr2_enG1_nocor/cosh(STr2_Eta_1) >1.0 && STr2_enG1_nocor/cosh(STr2_Eta_1) >1.0";
  TCut tcut = "Entry$%2==0";
  TCut mccut =  "Entry$%10==0";
  TCut mcrawcut =  "Entry$%10==1";
  ...
  RooDataSet *hdata = RooTreeConvert::CreateDataSet("hdata",treedata,vars,weightvar);   
...
//   RooDataSet *hdataD = RooTreeConvert::CreateDataSet("hdataD",tree,vars,weightvar);
 ...
 cout<<"DEBUG 009....."<<endl; 
  ...
  double step = 1.5/double(std::max(1,ngaus-1));
  cout<<"step:   "<<step<<endl; 
  for (int igaus=0; igaus<ngaus; ++igaus) {
    //RooRealVar *gmeanvar = new RooRealVar(TString::Format("gmeanvar_%i",igaus),"",log(80.)-logpdgPi0mass + step*igaus);
    RooRealVar *gmeanvar = new RooRealVar(TString::Format("gmeanvar_%i",igaus),"",log(0.05)-logpdgPi0mass + step*igaus);
    //RooRealVar *gsigmavar = new RooRealVar(TString::Format("gsigmavar_%i",igaus),"",0.02);
    RooRealVar *gsigmavar = new RooRealVar(TString::Format("gsigmavar_%i",igaus),"",0.2);
    //RooRealVar *gsigmaRvar = new RooRealVar(TString::Format("gsigmaRvar_%i",igaus),"",0.02);
    RooRealVar *gsigmaRvar = new RooRealVar(TString::Format("gsigmaRvar_%i",igaus),"",0.2);
 ...
 cout<<"DEBUG 009.03....."<<endl; 
//    RooRealConstraint *gmeanlim = new RooRealConstraint(TString::Format("gmeanlim_%i",igaus),"",*gmean,log(75.)-logpdgPi0mass,log(105.)-logpdgPi0mass);
    RooRealConstraint *gmeanlim = new RooRealConstraint(TString::Format("gmeanlim_%i",igaus),"",*gmean,log(0.04)-logpdgPi0mass,log(0.24)-logpdgPi0mass);
